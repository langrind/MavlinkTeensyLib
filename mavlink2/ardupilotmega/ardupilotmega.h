...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_DO_CALIBRATE_WING_ANGLE_SENSORS=188, /* Auto-calibrate wing angle sensors. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   ...
   MAV_CMD_DO_CALIBRATE_WING_ANGLE_SENSORS_AND_DIAL=215, /* Auto-calibrate wing angle sensors and RCX dial. |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
